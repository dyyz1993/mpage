// eslint-disable-next-line no-restricted-imports -- worker process: playwright allowed
...
// eslint-disable-next-line no-restricted-imports -- worker process: playwright types allowed
